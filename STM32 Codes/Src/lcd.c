...
void LCD_Init(void){
	...
	USER_TIM2_Delay(TIM_PSC_50MS, TIM_CNT_50MS);		//	Implement a 50 ms delay
	...
	USER_TIM2_Delay(TIM_PSC_5MS, TIM_CNT_5MS);			//	Implement a 5 ms delay
	...
	USER_TIM2_Delay(TIM_PSC_100US, TIM_CNT_100US);		//	Implement a 100 us delay
